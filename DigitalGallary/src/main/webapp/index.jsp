                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p>Today buy Instruments, music Accessories !</p>
                        </div>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Today Get 90% discount on Music Accessories !</h1>
                            <p>Music brings joy to your heart</p>
                        </div>
                    </div>
                </div>
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>2017 New Year Shopping </h1>
                            <p>Make your life Digital with Digital Gallery.</p>
                        </div>
                    </div>
                </div>
            </div>
