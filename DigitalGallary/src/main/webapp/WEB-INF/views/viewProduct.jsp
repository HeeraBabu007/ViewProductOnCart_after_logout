            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p ng-controller="cartCtrl">
                        <a href="<c:url value = "${url}" />" class="btn btn-default">Continue Shopping</a>
                        
                        <a href="http://localhost:8080/DigitalGallary/rest/cart/add/${product.productId}" class="btn btn-warning btn-large" ng-click="addToCart('${product.productId}')">
